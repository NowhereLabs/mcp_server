...
(function () {
    ...
    function connect() {
        ...
        if (connectionAttempts >= maxReconnectAttempts) {
            handleConnectionError(new Error(`Max reconnection attempts (${maxReconnectAttempts}) exceeded`), 'max_attempts_reached');
            return;
        }
        ...
        try {
            ...
            ws.onmessage = function (event) {
                ...
                switch (message.type) {
                    ...
                    case 'pong':
                        ...
                        break;
                    case 'error':
                        ErrorHandler.processError(ErrorHandler.createSystemError(message.message || 'Server error'), 'hot-reload', 'server_error');
                        break;
                    default:
            ...
            ws.onerror = function (error) {
                ...
                handleConnectionError(ErrorHandler.createNetworkError(errorMessage, { url: wsUrl }), 'connection_error');
            };
            ws.onclose = function (event) {
                ...
                handleConnectionError(ErrorHandler.createNetworkError(`Connection closed: ${event.reason || event.code}`, {
                    code: event.code,
                    reason: event.reason
                }), errorContext);
